"use strict";
const containerModa = document.createElement('div');
containerModa.classList.add('container-moda');
const headerModa = document.createElement('div');
...
const viewMore = () => {
    ...
    `;
        ...
        const imgProdutoModa = document.querySelector('.img-produto-moda');
...
const dadosProdutoModa = document.querySelector('.dados-produto-moda');
const modaPage = () => {
    main.innerHTML = '';
